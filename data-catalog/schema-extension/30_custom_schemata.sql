...
( run_uuid varchar(64) NOT NULL,
  ...
  CONSTRAINT fk_workflow_tag_uuid FOREIGN KEY(run_uuid) REFERENCES klms.workflow_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE
);
...
( run_uuid varchar(64) NOT NULL,
  ...
  PRIMARY KEY (run_uuid),
  CONSTRAINT fk_workflow_uuid FOREIGN KEY(workflow_uuid) REFERENCES klms.workflow_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT fk_next_task_uuid FOREIGN KEY(next_task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE SET NULL
);
...
( task_uuid varchar(64) NOT NULL,
  ...
  CONSTRAINT fk_task_tag_uuid FOREIGN KEY(task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE
);
...
( task_uuid varchar(64) NOT NULL,
  ...
  CONSTRAINT fk_task_metrics_uuid FOREIGN KEY(task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE
);
...
( task_uuid varchar(64) NOT NULL,
  ...
  "value" text,
  PRIMARY KEY (task_uuid, "key"),
  CONSTRAINT fk_task_parameters_uuid FOREIGN KEY(task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE
);
...
( task_uuid varchar(64) NOT NULL,
  ...
  CONSTRAINT fk_task_input_uuid FOREIGN KEY(task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE,
...
( task_uuid varchar(64) NOT NULL,
  dataset_id text NOT NULL, 
  PRIMARY KEY (task_uuid, dataset_id),
  CONSTRAINT fk_task_output_uuid FOREIGN KEY(task_uuid) REFERENCES klms.task_execution(run_uuid) ON UPDATE CASCADE ON DELETE CASCADE,
